...
class ListenerUtilsTest {
  ...
  void createListChangeListener() {
    ...
    ListChangeListener<String> listChangeListener = ListenerUtils.createListChangeListener(onAddItem::set, onRemoveItem::set, onUpdatedItem::set, onPermutatedItem::set);
